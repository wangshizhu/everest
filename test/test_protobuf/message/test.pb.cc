...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, 362, descriptor_table_protodef_test_2eproto, "test.proto", 
  &descriptor_table_test_2eproto_once, descriptor_table_test_2eproto_deps, 1, 3,
...
// @@protoc_insertion_point(class_specific_merge_from_start:tutorial.Person)
  ...
  if (from._internal_has_last_updated()) {
    _internal_mutable_last_updated()->::google::protobuf::Timestamp::MergeFrom(from._internal_last_updated());
  }
